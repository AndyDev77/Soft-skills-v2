            ...
            <div class="clearfix logo-nav-box pd-left-right-50px">
                <div class="container-fluid">
                    <div class="logo-nav-box-container">
                        <!-- Logo -->
                        <a href="index.html" class="logo d-flex align-items-center k-hover">
                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>register_soft_logic.php" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Accès aux soft-skills : inscription</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="txtFirstName3" name="name" placeholder="Nom/Prénom" value="<?= $name ?>">

                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtUsername3" class="form-label">Téléphone<span class="text-danger">*</span></label>
                                                    <input type="tel" class="form-control form-control-lg" id="txtUsername3" name="phone" placeholder="Téléphone" required value="<?= $phone ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtEmail3" class="form-label">Email<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtEmail3" type="email" name="email" placeholder="Email" value="<?= $email ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtPassword3" class="form-label">Mot de passe<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtPassword3" type="password" name="createpassword" placeholder="Crée un mot de passe" value="<?= $createpassword ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtRetypePassword3" class="form-label">Confirmez votre mot de passe<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtRetypePassword3" type="password" name="confirmpassword" placeholder="Confirme votre mot de passe" value="<?= $confirmpassword ?>">
                                                </div>
                                            </div>
                                            <!-- <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtListStatus" class="form-label">Liste déroulante des status<span class="text-danger">*</span></label>
                                                    <select name="status" id="txtListStatus" class="form-control form-control-lg">
                                                        <option value="0">Visiteurs</option>
                                                        <option value="1">Adhérents</option>
                                                        <option value="2">Partenaires</option>
                                                        <option value="3">Taxe d'apprentissage</option>
                                                        <option value="4">Apprenants</option>
                                                    </select>
                                                </div>
                                            </div> -->
                                        </div>
                                        <div class="mb-3">
                                            <p>Vous avez déjà un compte ?<a href="login_soft.php"> Connectez-vous</a></p>
                                        </div>
